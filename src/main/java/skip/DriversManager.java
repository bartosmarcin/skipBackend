...
public class DriversManager {
	...
	public Driver addDriver(Driver d) {
		Set<ConstraintViolation<Driver>> errors = validator.validate(d);
		if (errors.size() > 0) {
			return null;
		}
	...
	public Coordinates updateDriverCoordinates(Coordinates coordinates,
			long driverId) {
		Set<ConstraintViolation<Coordinates>> errors = validator
